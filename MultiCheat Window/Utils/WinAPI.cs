...
namespace MultiCheat_Window.Utils
{
    ...
    public class WinAPI
    {
        ...
        public static void AimAtPos(float x, float y, int screenW, int screenH, float smoothCof = 0.2f)
        {
            float TargetX = 0;
            float TargetY = 0;
            ...
            WinAPI.mouse_event(WinAPI.MOUSEEVENTF.MOVE, (uint)(TargetX), (uint)(TargetY), 0, 0);
            return;
            /* SMOOTH
        ...
        public static UInt32 SendInput(UInt32 nInputs, INPUT[] inputs) => SendInput(nInputs, inputs, Marshal.SizeOf(typeof(INPUT)));
        ...
        [Obsolete("keybd_event is deprecated, please use SendInput instead.")]
        [DllImport("user32.dll")]
        public static extern bool keybd_event(byte bVk, byte bScan, uint dwFlags,
            int dwExtraInfo);
